...
class AccountPayable extends Model {
  ...
  static::creating(function(self $payable):void{
   if(blank($payable->number)&&filled($payable->organization_id)){
    $payable->number=app(NumberSequenceService::class)->next(
     organizationId:$payable->organization_id,key:'account_payable',name:'Contas a pagar',prefix:'CP-',padding:8
    );
   }
  });
 ...
 protected function casts():array {
  return ['issued_at'=>'date','competence_date'=>'date','due_at'=>'date','approved_at'=>'datetime',
   'original_value'=>'decimal:2','interest_value'=>'decimal:2','penalty_value'=>'decimal:2',
   'discount_value'=>'decimal:2','paid_value'=>'decimal:2','open_value'=>'decimal:2',
   'metadata'=>'array','bank_snapshot'=>'array'];
 }
